...
Colors.healthGroup.args.healthBreak.args.customMult = ACH:Range(L["Health Backdrop Multiplier"], L["Use the custom backdrop color instead of a multiple of the main color. Default [0.35]"], 8, { min = 0, softMax = 0.75, max = 1, step = 0.01 }, nil, nil, nil, function() return not E.db.unitframe.colors.healthBreak.colorBackdrop end)
...
Colors.healthGroup.args.healthBreak.args.bad = ACH:Color(L["Bad"], nil, 12)
